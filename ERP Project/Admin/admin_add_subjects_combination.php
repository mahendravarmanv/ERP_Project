                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Subject Combination</h2>                        
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Subject Combination Info</h5>
                                                </div>
                                            </div>
<form action="admin_subject_combination_allot.php" method="post">
    <div align="center">
		...
		<select name="in_subject" class="list-group-item">
            <?php
            $q = mysqli_query(mysqli_connect('localhost','root','','erp_project'),
