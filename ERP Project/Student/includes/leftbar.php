                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Student Attendence</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="student_view_attendance.php"><i class="fa fa-bars"></i> <span>View Attendance</span></a></li>
                                            
                                            
                                        </ul>
                                    </li>
									<li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Student Result</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="student_view_result.php"><i class="fa fa-bars"></i> <span>View Result</span></a></li>
                                        </ul>
                                    </li>
									<li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Student Feedback</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="feedback.php"><i class="fa fa-bars"></i> <span>Send Feedback</span></a></li>
                                        </ul>
                                    </li>
